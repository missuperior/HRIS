                                ...
                                <div class="widget-toolbar no-border">
                                        <ul class="nav nav-tabs" id="myTab">
                                                ...
                                                <li>
                                                 ...
                                                 <li>
                                                        <a data-toggle="tab" href="#leave">Add leave</a>
                                                </li>

                                        </ul>
                                </div>
										</div>
 <form target="_blank" class="form-horizontal" id="employeeform" method="POST" action="<?php echo  base_url()?>attendance/save_emp_absent" />
                      ...
                      <?php } ?>
                        ...
                        <div id="disp"></div>
                            ...
                            <a onclick="getempbycode()"  class="btn btn-purple btn-small" style="margin-top:0px;" >
                            Search
  ...
  <div class="row-fluid" style="float:left; width:190px">
                            <select style="width: 180px;" id="leave_type" name="leave_type">                                 
                              <option value="">-- Select Leave  Type --</option>
                              <?php  foreach ($leaves as $c){?>
                                  <option value="<?php echo $c['leaveid']?>"><?php echo $c['leavetype']?></option> 
                              <?php }?>																				
                            </select>
                        </div>
...
<!--              <label style="width: 100px;" class="row-fluid">Start Date: <img src="<?php echo base_url() ?>assets/img/star.jpg" width="6"/></label>-->
                                       ...
                                       <div class="row-fluid" style="float:left; width:190px">     
                                          ...
                                          <input style="width: 100px;" type="date"  name="end_date" placeholder="End Date" id="end_date" class="span6 date-picker" data-date-format="yyyy-mm-dd" readonly />
                                          <h6 style="color:red; margin: 0px;"><?php echo form_error('joining_date'); ?></h6>
                                       </div>
                        ...
                        <button id="search_attendance" class="btn btn-purple btn-small" style="margin-top:0px;" >
                            Add
                            <i class="icon-angle-right icon-on-right bigger-110"></i>
                        </button>
