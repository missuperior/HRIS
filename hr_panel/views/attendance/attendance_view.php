            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main" style="min-height: 40px">
                      <form target="_blank" class="form-horizontal" id="employeeform" method="POST" action="<?php echo  base_url()?>attendance/employee_attendance_report" />
               ...
               <label style="width: 140px;" class="row-fluid">Start Date: <img src="<?php echo base_url() ?>assets/img/star.jpg" width="6"/></label>
                                          <input style="width: 300px;" type="date"  name="att_date" id="att_date" class="span6 date-picker" data-date-format="yyyy-mm-dd" readonly required />
                                          <h6 style="color:red; margin: 0px;"><?php echo form_error('joining_date'); ?></h6>
             
                 
                                          
                                          <label style="width: 140px;" class="row-fluid">End Date: <img src="<?php echo base_url() ?>assets/img/star.jpg" width="6"/></label>
                                          <input style="width: 300px;" type="date"  name="end_date" id="end_date" class="span6 date-picker" data-date-format="yyyy-mm-dd" readonly required />
                                          <h6 style="color:red; margin: 0px;"><?php echo form_error('joining_date'); ?></h6>
