            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main" style="min-height: 40px">
                      <form target="_blank" class="form-horizontal" id="employeeform" method="POST" action="<?php echo  base_url()?>attendance/get_detail_report" />
             ...
             <div class="row-fluid" style="width:130px">
