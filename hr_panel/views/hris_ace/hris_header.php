...
<!--        <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js"></script>-->
        ...
        <link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Open+Sans:400,300" />
         ...
         <?php if($this->session->userdata('css_type') == 'green'){ ?>  
          <link rel="stylesheet" href="<?php echo base_url();?>assets/css/ace.min_green.css" />
    <?php }else { ?>
    ...
    <?php }?>
        ...
        <link rel="stylesheet" href="<?php echo base_url();?>assets/css/uiTheme.css" />
        <link rel="stylesheet" href="<?php echo base_url();?>assets/css/ui-theam.css" />
        ...
        <div class="navbar">
            <div class="navbar-inner">
                <div class="container-fluid">
                    <a href="<?php echo base_url(); ?>hris/dashboard" class="brand">
                        <small>
                          <?php if($this->session->userdata('company_name') == 'Daily Nai Baat'){ ?>  
                            <img src="<?php echo base_url();?>assets/avatars/nb_logo.png" />
                          <?php }else{?>
                            <img src="<?php echo base_url().$this->session->userdata('company_image');?>" width="40" height="40" border="1" />
                          <?php } ?>
                            <?php  echo $this->session->userdata('company_name'); ?> - Human Resource Information System
                        </small>
                    </a><!--/.brand-->
                            ...
                            <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                              <!--<img style="margin-right: 10px;" src="<?php //echo base_url();?>assets/avatars/nb_logo.png" />-->
                                <span class="user-info">
                                    <small>Welcome,</small>
                                    <?php echo $this->session->userdata('hris_username');?>
                                </span>
...
<!--                                <li>
                                ...
                                <li>
                                    <a href="<?php echo base_url(); ?>hris/logout">
                                        <i class="icon-off"></i>
                                        Logout
                                    </a>
                                </li>
