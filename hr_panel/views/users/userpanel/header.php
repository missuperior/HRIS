                ...
                <div class="container-fluid">
                    <a href="<?php base_url(); ?>dashboard" class="brand">
                        <small>
                          ...
                          <?php } ?>
                            Superior Group - Human Resource Information System - Employee Portal
                        </small>
                    </a><!--/.brand-->
...
<!--								<img class="nav-user-photo" src="<?php //echo base_url(); ?>user_assets/assets/avatars/user.jpg" alt="Jason's Photo" />-->
								<span class="user-info">
									<small>Welcome,</small>
									 <?php $user = explode('@', $this->session->userdata('emp_name')); echo $user[0]; ?>
								</span>
