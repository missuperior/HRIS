...
<!--        <small>
    ...
    <div class="row-fluid">
      <div class="span12">
              ...
              <tr>                                                                                        
                ...
                <td class="td-actions">
                  <div class="hidden-phone visible-desktop action-buttons">
                    <a class="green" href="<?php echo base_url() ?>hris/edit_increment/<?php echo $row['emp_salary_id']; ?>/<?php echo $employee[0]['emp_id']; ?>">
        ...
        <?php 
        $attribute = array('id' => 'incrementForm', 'class' => 'form-horizontal');
        echo form_open('hris/add_increment', $attribute); 
        ?>
        ...
        <input type="hidden" id="updated_current_salary" name="updated_current_salary" value="<?php echo $netSalary[0]['updated_current_salary']; ?>" />
         ...
         <div class="control-group">
          <label class="control-label" for="form-field-1">Increment : <img src="<?php echo base_url() ?>assets/img/star.jpg" width="6"/></label>

          <div class="controls">
            <input type="text" id="increment_amount" name="increment_amount" placeholder="" onkeyup="this.value=formatCurrency(this.value);" />
            <h6 style="color:red; margin: 0px;"><?php echo form_error('increment_amount'); ?></h6>
          </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <span class="span12">
                    <select style="width: 248px;" id="increment_type" name="increment_type" class="select2" data-placeholder="Click to Choose...">
                      <option value="">-- Select Type --</option>                                                        
                      <option value="Permanent">Permanent</option>                                                        
                      <option value="Temporary">Temporary</option>                                                        
                    </select>
                </span>
            <h6 style="color:red; margin: 0px;"><?php echo form_error('increment_type'); ?></h6>
            </div>
        </div>
        
        <div id="increment_date" class="control-group">
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <textarea cols="70" rows="5" name="increment_detail"></textarea>
            <h6 style="color:red; margin: 0px;"><?php echo form_error('increment_detail'); ?></h6>
          </div>
        </div>
