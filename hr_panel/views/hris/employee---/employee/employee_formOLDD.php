        ...
        <div class="row-fluid">
          <div class="span12">
            ...
            <div onclick="return show(this.id);" id="1" style="width:11.5%; float: left; color: white; background-color:  #006E6F; font-weight: bold; cursor: pointer; " class="widget-header widget-header-blue widget-header-flat">
              ...
              <div  onclick="return show(this.id);" id="2"  style="width:10%; float: left; color: white; background-color:  #006E6F; font-weight: bold; cursor: pointer; " class="widget-header widget-header-blue widget-header-flat">
                <h4 class="lighter">Personal</h4>
              </div>
              
              <div onclick="return show(this.id);" id="3"  style="width:10%; float: left; color: white; background-color:  #006E6F; font-weight: bold; cursor: pointer; " class="widget-header widget-header-blue widget-header-flat">
                <h4 class="lighter">Contact</h4>
              </div>
              
              <div  onclick="return show(this.id);" id="4"    style="width:10%; float: left; color: white; background-color:  #006E6F; font-weight: bold; cursor: pointer; " class="widget-header widget-header-blue widget-header-flat">
                <h4 class="lighter">Medical</h4>
              </div>
              
              <div  onclick="return show(this.id);" id="5"   style="width:14.5%; float: left; color: white; background-color:  #006E6F; font-weight: bold; cursor: pointer; " class="widget-header widget-header-blue widget-header-flat">
                <h4 class="lighter">Qualification</h4>
              </div>
              
              <div  onclick="return show(this.id);" id="6"   style="width:14.5%; float: left; color: white; background-color:  #006E6F; font-weight: bold; cursor: pointer; " class="widget-header widget-header-blue widget-header-flat">
                <h4 class="lighter">Work Experience</h4>
              </div>
              
              <div  onclick="return show(this.id);" id="7"   style="width:10%; float: left; color: white; background-color:  #006E6F; font-weight: bold; cursor: pointer; " class="widget-header widget-header-blue widget-header-flat">
                <h4 class="lighter">References</h4>
              </div>
              
              <div  onclick="return show(this.id);" id="8"   style="width:10%; float: left; color: white; background-color:  #006E6F; font-weight: bold; cursor: pointer; " class="widget-header widget-header-blue widget-header-flat">
...
<!--              <div class="widget-header widget-header-blue widget-header-flat">
      ...
      <p style="float:left;margin-left: 20px;margin-top:2px;font-weight: bold;">Same as Above</p> <br/>
                              ...
                              <tbody>
                                  <tr>
                                      <td>
                                          ...
                                          <input style="width: 300px;" type="text" name="business_name[]" id="business_name" value="<?php echo set_value('business_name'); ?>" class="span6" />
                 ...
                 <input style="margin-top:20px; float:right" type="submit" value="Add Employee" class="btn btn-info"/>
                      </div>
