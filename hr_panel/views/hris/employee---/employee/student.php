...
class student extends CI_Controller {
  ...
  public function index() {
    ...
    $this->load->view('student_new/login-latest');
  }
  ...
  public function student_login() {
    ...
    if ($this->form_validation->run() == FALSE) {
      ...
      $this->load->view('student_new/login-new');
    } 
    else {      
...
//    $result['batches']  = $this->Admin_model->getAllbatches();
  ...
  public function student_profile()
  {
    ...
    public function view_financial()
    {
        ...
        $this->load->view('student_ace/student_header_new');
        $this->load->view('student_new/view_financial', $result);  
        $this->load->view('student_ace/student_footer_new');
    }
    ...
    public function course_registration()
    {
        ...
        $this->load->view('student_new/course_regristration', $result);  
        $this->load->view('student_ace/student_footer_new');    
    }
