s<div class="main-content">
  <div class="breadcrumbs" id="breadcrumbs">
    <ul class="breadcrumb">
      ...
      <li class="active">Edit Increment</li>
    </ul><!--.breadcrumb-->
...
<!--        <small>
    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        echo form_open('hris/update_increment', $attribute); 
        ?>
        ...
        ?>
         ...
         <div class="control-group">
          ...
          <div class="controls">
            <input type="text" id="increment_amount" name="increment_amount" value="<?php echo $salary[0]['amount'] ?>" placeholder="" onkeyup="this.value=formatCurrency(this.value);" />
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <textarea cols="50" rows="5" name="increment_detail">
