  ...
  <div class="page-content">
    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        echo form_open('hris/add_visitor', $attributes); ?>
        <div class="control-group">
          <label class="control-label" for="form-field-1">Visitor Name :</label>

          <div class="controls">
            <input type="text" id="visitor_name" name="visitor_name" placeholder="e.g: Aqeel Ahmad" />
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <input type="text" id="cnic" name="cnic" placeholder="32659-2659854-7" />
