  ...
  <div class="page-content">
    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        echo form_open('hris/edit_grade', $attributes); ?>
        <input type="hidden" name="id" value="<?php echo $grade[0]['grade_id']; ?>">
        <div class="control-group">
          <label class="control-label" for="form-field-1">Title :</label>

          <div class="controls">
              <input type="text" id="title" name="title" value="<?php echo $grade[0]['class']; ?>"/>
          ...
          <div class="controls">
            <select id="status" name="status">
                <option value="1" <?php if($grade[0]['status']==1){ echo 'selected';} ?>>Active</option>
                <option value="0" <?php if($grade[0]['status']==0){ echo 'selected';} ?>>De-active</option>
            </select>
          </div>
        </div>
        <br /><br />
