                            ...
                            <div class="widget-body">
                                <div class="widget-main">                                  
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <?php $i=1;foreach ($grades as $value) {
                                            echo '<tr>';
                                            echo '<td>'.$i.'</td>';
                                       ...
                                       <td><a href="<?php echo base_url()?>hris/delete_grade/<?php echo $value['grade_id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>/<a href="<?php echo base_url()?>hris/edit_grade_form/<?php echo $value['grade_id']; ?>">Edit</a></td>
