    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <?php $attributes = array('id' => 'cityForm', 'class' => 'form-horizontal');
              echo form_open('hris/save_religion', $attributes); ?>
        <div class="control-group">
          <label class="control-label" for="form-field-1">Add Religion :</label>

          <div class="controls">
            <input type="text" id="city_name" name="religion" placeholder="" />
