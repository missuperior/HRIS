                            ...
                            <div class="widget-body">
                                <div class="widget-main">                                  
                                    <table class="table table-striped table-bordered table-hover">
                                       ...
                                       <td><a href="<?php echo base_url()?>hris/delete_benefit/<?php echo $value['benefit_id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>/<a href="<?php echo base_url()?>hris/edit_benefit_form/<?php echo $value['benefit_id']; ?>">Edit</a></td>
