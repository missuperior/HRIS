...
<!--                      <li class="active">
                      ...
                      <li>
                        <a data-toggle="tab" href="#documents" style="background: #006E6F !important; color:#fff !important;">
                          <i class="green fa fa-file-text"></i>
                          Documents
                        </a>
                      </li>-->
                      <a data-toggle="tab" href="#employment">
                       <button  href="#employment"  style="font-size: 10px; float: left; color: white; background-color:  #006E6F; font-weight: bold; cursor: pointer; "  id="1"  class="btn btn-app btn-default btn-mini">
<i class="icon-info bigger-160"></i>
Employment
</button>
                      </a>
<a  data-toggle="tab" href="#personal">
<button  style="font-size: 10px; float: left; color: white; background-color:  #006E6F; font-weight: bold; cursor: pointer; "  id="2"  class="btn btn-app  btn-yellow btn-mini">
