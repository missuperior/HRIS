                   ...
                   <!--***************       Start HTML For Step1 (Employement Tab)     ****************-->
                      ...
                      <?php } ?>
                                  ...
                                  <tr>
                                      ...
                                      <td>  
                                          <label style="width: 200px;" class="control-label">Grade:<img src="<?php echo base_url() ?>assets/img/star.jpg" width="6"/></label>
                                  ...
                                  <tr>
                                      ...
                                      <?php if( $this->session->userdata('company_type') == 'city'){ ?>
                                      <td>  
                                         <label style="width: 200px;" class="control-label">City:<img src="<?php echo base_url() ?>assets/img/star.jpg" width="6"/></label>
                                  ...
                                  <tr>
                                      <td colspan="1">   
                                          ...
                                          <select style="width: 300px;" id="probation_period" name="probation_period[]"  required>
                                              <option value="">-- Select Shift --</option>
                                      ...
                                      <td>
                                          ...
                                          <select style="width: 300px;" id="ad_employee_type" name="ad_employee_type[]" required>
                                              <option value="">-- Select Type --</option>                                          
