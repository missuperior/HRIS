    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <?php $attributes = array('id' => 'cityForm', 'class' => 'form-horizontal');
              echo form_open('hris/update_country', $attributes); ?>
        <div class="control-group">
          <label class="control-label" for="form-field-1">Add Country :</label>

          <div class="controls">
            <input type="text" id="city_name" name="country" value="<?php echo $data['country']; ?>" placeholder="" />
            <input type="hidden" id="city_name" name="country_id" value="<?php echo $data['country_id']; ?>" placeholder="" />
