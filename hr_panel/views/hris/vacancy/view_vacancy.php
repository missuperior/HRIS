                    ...
                    <tr id="ch">
                      ...
                      <td class="td-actions">
                        <div class="hidden-phone visible-desktop action-buttons">
                          ...
                          <a class="green" href="<?php echo base_url() ?>vacancy/update_vacancy_form/<?php echo $row['vecancy_id']; ?>">
                            <i class="icon-pencil bigger-130" title="Edit"></i>                                                            
                          </a>
                          <a class="" href="<?php echo base_url() ?>vacancy/full_vacancy_view/<?php echo $row['vecancy_id']; ?>">                                                            
                            <i class="fa fa-file-text" title="View vacancy detail"></i>                                                         
                          </a>
